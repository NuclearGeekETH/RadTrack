  ...
  return (
    <>
      ...
      >
        ...
        <div className="p-8 mb-6 px-4 border-2 rounded-lg shadow bg-black bg-opacity-50 w-full md:w-1/2 mt-20 z-20">
          <Mint />
        </div>
        <div className="p-8 mb-6 px-4 border-2 rounded-lg shadow bg-black bg-opacity-50 w-full md:w-1/2 z-20">
          <AddDose />
        </div>
        <div className="p-8 mb-6 px-4 border-2 rounded-lg shadow bg-black bg-opacity-50 w-full md:w-1/2 z-20">
          <AddDoseERC />
