  ...
  return (
    <div className=''>
      <Head>
        ...
        <meta property="og:canonical" content="https://radtrack.vercel.app/admin-lookup" key="canonical" />
        <meta property="og:url" content="https://radtrack.vercel.app/admin-lookup" key="url" />
